...
public class UsuarioResource {
     ...
     * creado por Carlos Alba Este metodo se encarga de ser el constructor de la
     * parte web
     */
    ...
    /**
     * Esta es la documentación del metodo usuarioresource. Este metodo ha sido
     * creado por Carlos Alba Este metodo se encarga de ser el constructor de la
     * parte web
     *
     * @param usuarioLogic
     */
    @Inject
    public UsuarioResource(UsuarioLogic usuarioLogic) {
    ...
    /**
     * Esta es la documentación del metodo listentitytodto. Este metodo ha sido
     * creado por Carlos Alba Este metodo se encarga de Convierte una lista de
     * UsuarioEntity a una lista de UsuarioDetailDTO.
     *
    ...
    /**
     * Esta es la documentación del metodo getusuarios. Este metodo ha sido
     * creado por Carlos Alba Este metodo se encarga de Obtiene la lista de los
    ...
    /**
     * Esta es la documentación del metodo getusuario. Este metodo ha sido
     * creado por Carlos Alba Este metodo se encarga de Obtiene los datos de una
     * instancia de Usuario a partir de su ID
     *
    ...
    /**
     * Esta es la documentación del metodo updateusuario. Este metodo ha sido
     * creado por Carlos Alba Este metodo se encarga de Actualiza la información
     * de una instancia de Usuario
     *
    ...
    /**
     * * Esta es la documentación del metodo deleteusuario. Este metodo ha sido
     * creado por Carlos Alba Este metodo se encarga de Elimina una instancia de
    ...
    /**
     * Esta es la documentación del metodo getdireccionesusuario. Este metodo ha
     * sido creado por Carlos Alba Este metodo se encarga de
     *
     * @param usuariosId
     * @return
     */
    ...
    /**
     ** Esta es la documentación del metodo getpuntosusuario. Este metodo ha
     * sido creado por Carlos Alba Este metodo se encarga de
     *
     * @param idUsuario
     * @return
    ...
    /**
     * Esta es la documentación del metodo getreservasusuario. Este metodo ha
     * sido creado por Carlos Alba Este metodo se encarga de
     *
     * @param idUsuario
     * @return
