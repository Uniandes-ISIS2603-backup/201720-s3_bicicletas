...
public class EstacionDireccionResource {
    ...
    @POST
    @Path("{direccionesId: \\d+}")
    public DireccionDetailDTO addDireccions(@PathParam("estacionesId") Long estacionesId, @PathParam("direccionesId") Long direccionesId) {
     ...
     */
    @PUT
    public List<DireccionDetailDTO> replaceDireccions(@PathParam("estacionesId") Long estacionesId, List<DireccionDetailDTO> direcciones) {
    ...
    @DELETE
    @Path("{direccionesId: \\d+}")
    public void removeDireccion(@PathParam("estacionesId") Long estacionesId, @PathParam("direccionesId") Long direccionesId) {
