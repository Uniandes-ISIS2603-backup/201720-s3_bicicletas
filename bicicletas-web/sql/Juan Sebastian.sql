...
insert into App.BICICLETAENTITY(ID, ESTADO, MARCA, MODELO, ESTACION_ID) VALUES (200, 2, 'Merida', 'Carretera', 200);
insert into App.ACCESORIOBICICLETAENTITY(ID,DESCRIPCION,NAME,NOMBRE,BICI_ID) values(200,'negra','acc',2,200);
insert into App.BICICLETAENTITY_ACCESORIOBICICLETAENTITY(BICICLETAENTITY_ID,ACCESORIOS_ID)values (200,200);