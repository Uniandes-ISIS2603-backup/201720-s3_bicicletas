...
insert into App.USUARIOENTITY(DOCUMENTOUSUARIO, CONTRASENIAPSE, FECHANACIMIENTO, NOMBRE, NUMEROCSV, TARJETACREDITO, TIPOID, PASSWORD) values (111,'clave','06/30/1997','Administrador 1',111,43218928723472,3,'clave');
insert into App.USUARIOENTITY(DOCUMENTOUSUARIO, CONTRASENIAPSE, FECHANACIMIENTO, NOMBRE, NUMEROCSV, TARJETACREDITO, TIPOID, PASSWORD) values (123,'clave','06/30/1995','Administrador 2',123,43218928723471,3,'clave');
