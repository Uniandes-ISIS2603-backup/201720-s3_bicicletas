...
insert into App.PUNTOENTITY(ID, FECHAPUNTO, FECHAVENCIMIENTO, USUARIOPUNTO_DOCUMENTOUSUARIO) values (111, '2017-12-04 20:59:47.172','2018-12-04 20:59:47.172', 3488291091);

/*Reservas*/
insert into App.RESERVAENTITY(ID, DESCUENTO, ESTACIONLLEGADA, ESTACIONSALIDA_ID, ESTADO, FECHAINICIO, FECHAENTREGA, FECHAFINAL, FECHARESERVA, PRECIOFINAL, USUARIORESERVA_DOCUMENTOUSUARIO) values (100, 1, 105, 104, 5, '2017-11-06 11:00:00.172', '2017-11-06 20:00:00.172', '2017-11-04 19:00:47.172', '2017-11-06 20:00:00.172', 15.000, 3488291091);
insert into App.PAGOENTITY(ID, BICICLETASPENDIENTES, ESTADO, FECHA, IDUSUARIO, MONTO, RESERVA_ID) values (100, 0, 0, '2017-11-04 21:00:00.172', 3488291091, 15000, 100);
update App.RESERVAENTITY set PAGO_ID=100 where ID=100;
